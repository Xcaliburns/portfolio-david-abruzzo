<template>
  <section class="projects">
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>🌐Application full-stack en microservices avec gateway et docker</h2>
        <div class="project-tags">
...
🧰 Technologies utilisées : .NET, C#, MongoDB, SQL Server, REST API, Docker</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>🌐Amelioration d'une application avec des systemes distribués</h2>
        <div class="project-tags">
          <span class="tag">C#</span>
          <span class="tag">.Net</span>
...
🧰 Technologies utilisées : .NET, C#, CI/CD, SQL Server, MongoDB</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>Rendez votre back-end .NET plus flexible avec une API REST</h2>
        <div class="project-tags">
          <span class="tag">C#</span>
          <span class="tag">.Net</span>
...
🧰 Technologies utilisées : SQL Server, C#, Entity Framework, .NET</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>Application MVC avec ASP .NET Core</h2>
        <div class="project-tags">
...
🧰 Technologies utilisées : ASP .NET Core, C#, Razor Pages, HTML/CSS, SQL Server</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>Désign d'une application .NET adaptée aux besoins d’un client</h2>
        <div class="project-tags">
          <span class="tag">Trello</span>
          <span class="tag">Choix techniques</span>
...
🧰 Technologies abordées : .NET, C#, SQL Server, Entity Framework, Agile, UML</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>Test et implémentation d’une nouvelle fonctionnalité .NET</h2>
        <div class="project-tags">
          <span class="tag">.Net</span>
          <span class="tag">Tests unitaires</span>
          <span class="tag">Tests d’intégration</span>
...
🧰 Technologies utilisées : .NET, C#, xUnit, SQL Server, Entity Framework</p>
    ...
    <div class="project-card">
      <div class="project-header">
        <h2>Débogage d’une application .NET</h2>
        <div class="project-tags">
